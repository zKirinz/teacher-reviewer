...
const Footer = () => {
    ...
    return (
        <Stack w="100%" direction="row" justifyContent="space-between" alignItems="center" px="2">
            ...
            >
                ...
                <ModalContent>
                    ...
                    >
                        ...
                        <Text>
                            Từ đó, các bạn học sinh có thể tìm hiểu, tham khảo cũng như biết được
                            giáo viên nào phù hợp nhất với mình để nâng cao chất lượng học tập.
                        </Text>
                        ...
                        <UnorderedList>
                            ...
                            <ListItem>
                                Do nhóm mình không thể chắt lọc được tất cả các đánh giá nên mong
                                các bạn hãy đánh giá một cách có trách nhiệm để tạo nên 1 cộng đồng
                                <Box as="span" color="yellow.500">
                                    &nbsp;Teacher Reviewer&nbsp;
                                </Box>
                                chất lượng.
                    ...
                    >
                        <Text fontSize="md">
                            Mọi thắc mắc hoặc ý tưởng muốn trao đổi xin vui lòng liên hệ qua
                            email&nbsp;
                            <Link isExternal href="mailto:tran123456k@gmail.com" color="teal.500">
                                tran123456k@gmail.com
                            </Link>
                        </Text>
                    </Stack>

                    <ModalFooter pb={6} pt={isLargerThan768 ? 2 : 1}>
                        <Button colorScheme="teal" size="md" fontSize="xl" mr={3} onClick={onClose}>
                            Close
                        </Button>
                    </ModalFooter>
                </ModalContent>
